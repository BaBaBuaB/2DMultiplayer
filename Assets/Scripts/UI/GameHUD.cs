...
public class GameHUD : NetworkBehaviour
{
    ...
    public override void OnNetworkSpawn()
    {
        ...
        lobbyCode.Value = HostSingletron.Instance.GameManager.JoinCode;
    }
    ...
    public void LeaveGame()
    {
        ...
        {
            HostSingletron.Instance.GameManager.Shutdown();
        }

        ClientSingletron.Instance.GameManager.Disconnect();
    }
